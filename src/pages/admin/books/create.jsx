          ...
          <div className="max-w-2xl px-4 py-8 mx-auto lg:py-16">
            ...
            <form action="#">
              <div className="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                    dark:text-white dark:focus:ring-indigo-500 dark:focus:border-indigo-500"
                    defaultValue="Standard glass, 3.8GHz 8-core Intel Core i7 processor..."
                  />
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <button
                  type="button"
                  className="text-red-600 inline-flex items-center hover:text-white border border-red-600 
